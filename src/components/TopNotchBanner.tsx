        ...
        >
          ...
          >
            <div 
              ...
              className="mx-auto max-w-4xl mt-4 bg-gradient-to-r from-primary via-accent to-primary p-[2px] rounded-2xl shadow-2xl cursor-pointer pointer-events-auto group"
            >
